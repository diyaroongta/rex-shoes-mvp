...
- A BARE NUMBER IN BRACKETS IS NOT A CUSTOMER. A row beginning (1), (2), (3) followed by SIZES rather than by a name is the first, second or third lot of the product already named above. Keep those lines on that same order. Only a heading with an actual NAME in it starts a new customer.
...
WORKED EXAMPLE 3 - ROWS OF COLUMNS, AND A NUMBERED SECOND LOT. A sheet reading: "K.P. Gurgaon" / "Spike N.Blue/S.Blue" / a row of columns 10-over-1, 12-over-1, 13-over-2, 1-over-2, 3-over-1, 4-over-1, 5-over-1 with "= 9" at its end / then a second row "(2)" 6-over-2, 8-over-1, 10-over-1, 11-over-1 with "= 5" at its end / and "= 14 CTN" for the product
{"date":"","orders":[{"party":"K.P. Gurgaon","category":"Spike","color":"N.Blue / S.Blue","stated_cartons":14,"lines":[{"sizes":["10"],"cartons":1},{"sizes":["12"],"cartons":1},{"sizes":["13"],"cartons":2},{"sizes":["1"],"cartons":2},{"sizes":["3"],"cartons":1},{"sizes":["4"],"cartons":1},{"sizes":["5"],"cartons":1},{"sizes":["6"],"cartons":2},{"sizes":["8"],"cartons":1},{"sizes":["10"],"cartons":1},{"sizes":["11"],"cartons":1}]}]}
ELEVEN lines from ONE order - seven columns in the first row and four in the second. The "(2)" is the second LOT of the same Spike, not a second customer and not a second product, so its columns join the same order. 1+1+2+2+1+1+1 = 9 and 2+1+1+1 = 5, which is the 14 the sheet states, so the read is complete. Returning only the first row would give 9 and would be wrong. Note also that the same numeral appears twice - 10 in the first row is the Small run and 10 in the second row is the Large repeat - which is exactly what the ascending order is telling you; return both, and do not merge them.
